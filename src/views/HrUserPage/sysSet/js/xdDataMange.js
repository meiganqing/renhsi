...
var http_common = "", //http://192.168.28.251:8111
    ipUrl = http_common + "/xdData/xdDataManage.ashx?XAction=GetDataInterface&XKLX=SYYHGL",
    ipUploadUrl = http_common + "/xddata/xdFileAllSysUpload.ashx?XKLX=SYRSGL",
    basePathImg = http_common + "/rsgl_new/Widget",
    baseUrl = "/SYRSGL",
    ip_url = "/api/kf/data";
...
function delDatashu(id, XDLMSID, callback) { //删除数据
    layui.use(['layer'], function() {
        layer.confirm('确定要删除？删除后不可恢复！！', {
                btn: ['确定删除', '再想想'] //按钮
            },
...
var needLimit = true;
//if(window.location.hostname == "localhost") {
//	needLimit ? $(document).append('<script type="text/javascript" src="/wwbh/page/sysSetting/js/limit.js"></script>') : ""; //权限的js
//
//} else {
